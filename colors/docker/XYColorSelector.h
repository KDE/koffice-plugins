...
#ifndef XYCOLORSELECTOR_H
#define XYCOLORSELECTOR_H
...
class XYColorSelector : public KXYSelector
{
  Q_OBJECT

public:
    explicit XYColorSelector(const KoColorSpace* colorSpace,  QWidget *parent=0);
