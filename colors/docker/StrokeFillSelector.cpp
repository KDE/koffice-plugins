...
StrokeFillSelector::StrokeFillSelector(QWidget * parent)
...
StrokeFillSelector::~StrokeFillSelector()
{
...
void StrokeFillSelector::paintEvent(QPaintEvent* event)
{
...
QSize StrokeFillSelector::sizeHint() const
{
    return QSize(int(PANEL_SIZEX), int(PANEL_SIZEY));
}

QSize StrokeFillSelector::minimumSizeHint() const
{
    return QSize(int(PANEL_SIZEX), int(PANEL_SIZEY));
}

QSizePolicy StrokeFillSelector::sizePolicy() const
{
    return QSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
}

bool StrokeFillSelector::eventFilter(QObject *, QEvent *event)
{
...
void StrokeFillSelector::update(KShapeBorderBase * stroke, KShapeBackgroundBase * fill)
{
...
void StrokeFillSelector::drawFill(QPainter & painter, const KShapeBackgroundBase * fill)
{
    painter.save();

    if (fill) {
        const KGradientBackground * gradientFill = dynamic_cast<const KGradientBackground*>(fill);
        if (gradientFill) {
...
void StrokeFillSelector::drawStroke(QPainter & painter, const KShapeBorderBase * stroke)
{
    painter.save();
    ...
    if (stroke) {
        ...
        KShapeBorderBase * border = const_cast<KShapeBorderBase *>(stroke);
        painter.save();
        painter.setRenderHint(QPainter::Antialiasing, true);
...
#include <StrokeFillSelector.moc>
