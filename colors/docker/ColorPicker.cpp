...
#include "XYColorSelector.h"
#include "KoColorSlider.h"
#include "KoColorPatch.h"
#include "KoColorSpace.h"
#include <KoColorModelStandardIds.h>

ColorPicker::ColorPicker(QWidget *parent, bool opacitySlider)
    : QWidget(parent),
    m_showOpacitySlider(opacitySlider)
{
    m_xycolorselector = new XYColorSelector(rgbColorSpace(), this);
...
void ColorPicker::doComplexLayout()
{
...
void ColorPicker::doSimpleLayout()
{
...
void ColorPicker::changeLayout( LayoutType type )
{
    delete layout();
...
KoColor ColorPicker::color()
{
    return m_currentColor;
}

void ColorPicker::setColor(const KoColor & c)
{
    m_currentColor = c;
    updateValues();
...
void ColorPicker::slotHSVChanged()
{
    quint8 data[4];
...
void ColorPicker::slotRGBChanged()
{
    quint8 data[4];
    data[2] = m_RIn->value();
    data[1] = m_GIn->value();
...
void ColorPicker::slotSliderChanged(int v)
{
    quint8 data[4];
    data[3] = m_currentColor.colorSpace()->opacityU8(m_currentColor.data());
...
void ColorPicker::slotXYChanged(int u, int v)
{
    quint8 data[4];
    data[3] = m_currentColor.colorSpace()->opacityU8(m_currentColor.data());
    switch(m_activeChannel)
...
void ColorPicker::slotOpacityChanged(int o)
{
...
void ColorPicker::slotHSelected(bool s)
{
    if (s)
    {
...
void ColorPicker::slotSSelected(bool s)
{
    if (s)
    {
...
void ColorPicker::slotVSelected(bool s)
{
    if (s)
    {
...
void ColorPicker::slotRSelected(bool s)
{
    if (s)
    {
...
void ColorPicker::slotGSelected(bool s)
{
    if (s)
    {
...
void ColorPicker::slotBSelected(bool s)
{
    if (s)
    {
...
void ColorPicker::updateSelectorsR()
{
...
void ColorPicker::updateSelectorsG()
{
...
void ColorPicker::updateSelectorsB()
{
...
void ColorPicker::updateSelectorsCurrent()
{
    switch(m_activeChannel)
    {
        case CHANNEL_H:
...
void ColorPicker::announceColor()
{
    m_colorpatch->setColor(m_currentColor);
...
const KoColorSpace *ColorPicker::rgbColorSpace()
{
    return KoColorSpaceRegistry::instance()->rgb8();
}

const KoColorSpace *ColorPicker::labColorSpace()
{
    return KoColorSpaceRegistry::instance()->lab16();
}

const KoColorSpace *ColorPicker::cmykColorSpace()
{
    return KoColorSpaceRegistry::instance()->colorSpace( CMYKAColorModelID.id(), Integer8BitsColorDepthID.id(), 0);
}

void ColorPicker::RGBtoHSV(int R, int G, int B, int *H, int *S, int *V)
{
  unsigned int max = R;
  unsigned int min = R;
...
void ColorPicker::HSVtoRGB(int H, int S, int V, quint8 *R, quint8 *G, quint8 *B)
{
  *R = *G = *B = V;
