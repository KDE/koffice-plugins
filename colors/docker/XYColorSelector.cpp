...
XYColorSelector::XYColorSelector( const KoColorSpace* colorSpace, QWidget *parent )
    : KXYSelector( parent )
...
void XYColorSelector::setColors( const KoColor& topLeftColor, const KoColor& topRightColor,  const KoColor& bottomLeftColor, const KoColor& bottomRightColor)
{
...
void XYColorSelector::drawContents( QPainter *painter )
{
